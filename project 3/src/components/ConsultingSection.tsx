    ...
    <section className="relative py-32 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="flex flex-col items-center text-center mb-16">
          ...
          <h2 className="text-5xl font-bold mb-6 bg-gradient-to-b from-white to-[#CCAFFF] bg-clip-text text-transparent">
            KI Consulting für Ihren Erfolg
          </h2>
          
          <p className="text-lg text-[#CCAFFF] max-w-2xl mb-8">
        ...
        <div className="grid grid-cols-3 gap-8">
          {features.map((feature, index) => {
            ...
            return (
              <div
                key={index}
                className="group relative bg-[#1F103B]/10 backdrop-blur-sm rounded-2xl p-8 border border-[#ffffff0f] hover:border-[#4500F9]/30 transition-all duration-300"
              >
